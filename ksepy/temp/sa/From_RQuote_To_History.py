...
stock_engine = create_engine('mysql+pymysql://root:alhajeri@localhost/stockdb')
mubasher_engine = create_engine('mysql+pymysql://root:alhajeri@localhost/mubasher')
...
q = Session_S.query(t_rquotes_summary).filter(tt.datetime >= '2015-09-06')
